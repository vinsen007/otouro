...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark " id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="">OTOURO<span></span></a>
...
<footer class="ftco-footer bg-bottom" style="background-image: url({{asset('images/footer-bg.jpg')}});">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">OTOURO</h2>
        ...
        <li><span class="icon icon-map-marker"></span><span class="text">A/81 Block A Shastri Nagar Jaipur
                                   </span></li>
                            <li><a href="#"><span class="icon icon-phone"></span><span
                                        class="text">+91 9079823738</span></a></li>
                            <li><a href="#"><span class="icon icon-envelope"></span><span
                                        class="text">otouro@gmail.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
